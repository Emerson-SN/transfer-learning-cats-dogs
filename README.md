...
## ✅ Conclusão
O projeto demonstrou que o uso de **Transfer Learning** é eficaz para problemas de classificação de imagens, mesmo com conjuntos de dados relativamente grandes.

A reutilização de um modelo pré-treinado permitiu reduzir o tempo de treinamento e obter bons resultados, atendendo completamente aos objetivos do desafio proposto.
